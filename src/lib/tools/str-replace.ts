...
export const buildStrReplaceTool = (fileSystem: VirtualFileSystem) => {
  return tool({
    description:
      "A text editor tool for viewing, creating, and editing files. Use the create command to create new files, str_replace to modify existing files, insert to add lines, and view to read file contents.",
